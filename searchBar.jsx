...
SearchBar = React.createClass({
  ...
  render: function() {
        ...
        <div id="searchMap">
            <form className="navbar-form navbar-left noPadding" role="search" action="javascript:;">
                <div className="form-group">
                    ...
                    <label className="navbar-form form-group pull-left middle-label" onClick={() => this.refs.modalOptions.open()}>More <i className="glyphicon glyphicon-plus-sign"/> </label>
             
        </div>
       
    </div>
     <Modal options={modalOptions} ref="modalOptions"></Modal>
    </div>
    );
  },
    moreOptions : function(){
        ...
        this.setState({openMoresOptions:true});
        return true;
    }
});
